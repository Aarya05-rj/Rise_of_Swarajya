      ...
      >
        <div className="bg-[#111] border border-white/5 p-10 rounded-[2.5rem] shadow-2xl relative overflow-hidden">
          ...
          <div className="text-center mb-10">
            ...
            <p className="text-gray-500 font-light text-sm italic">"Victory to the brave"</p>
          </div>
          ...
          <div className="mt-8 text-center text-gray-500 text-sm">
            ...
            <Link to="/register" className="text-saffron hover:underline font-bold transition-all">Sign Up</Link>
          </div>
        </div>
